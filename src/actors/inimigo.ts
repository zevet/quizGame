...
export class Inimigo extends ex.Actor {
    ...
    onInitialize(engine: ex.Engine) {
        ...
        this.actions.moveTo(this.pos.x, this.pos.y + 800, Config.startSpeed)
                    .moveTo(this.pos.x + 800, this.pos.y, Config.startSpeed)
                    .moveTo(this.pos.x + 800, this.pos.y + 800, Config.startSpeed)
                    .moveTo(this.pos.x, this.pos.y, Config.startSpeed)
                    .repeatForever();
    ...
    private onPreCollision(evt: ex.PreCollisionEvent) {
        ...
        if(!(evt.other instanceof Inimigo || evt.other instanceof Alvo) &&
           !ex.Util.contains(Inimigo.Bullets, evt.other)) {
